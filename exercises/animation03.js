...
var cylinderGeometry3 = new THREE.CylinderGeometry(0.1, 0.1, 1.0, 25)
var cylinderMaterial3 = new THREE.MeshLambertMaterial({ color: 'rgb(206, 209, 25)' });
var cylinder3 = new THREE.Mesh(cylinderGeometry3, cylinderMaterial3)
cylinder2.add(cylinder3)

var cylinderGeometry4 = new THREE.CylinderGeometry(0.1, 0.1, 1.0, 25)
var cylinder4 = new THREE.Mesh(cylinderGeometry4, cylinderMaterial3)
...
function rotateCylinder() {
    ...
    if (animationOn) {
        ...
        cylinder3.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90)))

        cylinder4.matrix.multiply(mat4.makeRotationY(-angle2))
        cylinder4.matrix.multiply(mat4.makeTranslation(0.0, 0.5, 0.0))
        cylinder4.matrix.multiply(mat4.makeRotationZ(THREE.MathUtils.degToRad(90)))
    }
}
