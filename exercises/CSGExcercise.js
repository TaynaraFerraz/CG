...
function buildObjects()
{
   ...
   // Base objects
   let torusMesh = new THREE.Mesh( new THREE.TorusGeometry(1, 0.3, 20, 20))
   let cubeMesh = new THREE.Mesh(new THREE.BoxGeometry(4, 4, 2))
   ...
   cubeMesh.position.set(2, 0, 2);
   cubeMesh.rotateX(Math.PI/2);
   ...
   let handleCSG = torusCSG.subtract(cubeCSG);

   mesh1 = CSG.toMesh(handleCSG, auxMat)
