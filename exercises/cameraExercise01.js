...
function keyboardUpdate() {
   ...
   keyboard.update();
   if (keyboard.pressed("W")) camera.translateZ(pos.z - 1);
   if (keyboard.pressed("A")) camera.translateX(pos.x -1);
   if (keyboard.pressed("S")) camera.translateZ(pos.z + 1);
   if (keyboard.pressed("D")) camera.translateX(pos.x + 1);

   if (keyboard.pressed("Q")) camera.translateY(1);
   if (keyboard.pressed("E")) camera.translateY(-1);
